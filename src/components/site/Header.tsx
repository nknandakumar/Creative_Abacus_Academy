			...
			>
				<div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
					<Link href="/" className="flex items-center gap-2">
						<Image
							src="https://res.cloudinary.com/dk1zdm8gz/image/upload/v1752830737/CAC_logo-removebg-preview_loij72.webp"
							alt="Creative Abacus Academy Logo"
							width={42}
							height={42}
							className="w-full h-full"
						/>
						<span className="font-headline text-accent text-2xl font-bold">
							AbacusAce
						</span>
					</Link>
					...
					<div className="flex gap-4">
						...
						<Button
							asChild
							className="bg-accent rounded-full font-headline text-accent-foreground hover:bg-accent/90"
						>
