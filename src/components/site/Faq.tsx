...
const faqItems = [
	...
	},
	{
		...
		answer:
			"Parents are welcome to observe demo sessions by appointment to see our teaching methods in action.",
	},
	{
		question: "What makes Creative Abacus Academy different?",
		answer:
			"Our ISO certification, experienced trainers, and championship focus set us apart as the best abacus center in Shivamogga.",
	},
];
...
export default function Faq() {
	return (
		<section
			id="faq"
			className="w-full h-screen  flex justify-center items-center py-12 md:py-24 lg:py-32"
		>
				...
				<div className="mx-auto mt-12 max-w-3xl">
					<Accordion type="single" collapsible className="w-full">
						{faqItems.map((item, index) => (
							<BlurFade key={index} delay={0.2 + index * 0.07} inView>
								<AccordionItem key={index} value={`item-${index}`}>
									<AccordionTrigger className="font-headline text:sm md:text-lg text-left">
										{item.question}
									</AccordionTrigger>
