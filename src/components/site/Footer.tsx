			...
			<div className="container mx-auto grid grid-cols-1 gap-10 px-4 py-12 md:grid-cols-2 md:px-6">
				...
				<div className="flex flex-col gap-6">
					<Link href="/" className="flex items-center gap-2">
						...
						<span className="font-headline text-xl font-bold text-gray-100">
							Creative Abacus Academy
						</span>
					</Link>
					<p className="max-w-md text-sm text-gray-300">
						Empowering young minds through Abacus, Vedic Maths, and cognitive
						development programs. With certified training, structured levels,
						and a passion for excellence, we help children unlock their full
						mental potential.
					</p>
				</div>
				...
				<div className="flex flex-col gap-6">
					<div>
						...
						<div className="flex  gap-3">
							<Button
								asChild
								className="bg-white text-accent rounded-full px-4 font-headline "
							>
								<Link href="tel:9663444851">
									{" "}
						...
						<div className="flex flex-col gap-2 mt-4">
							...
							<a
								href="mailto:creativeabacusacademy@gmail.com"
			...
			<div className="border-t border-gray-700">
				<div className="container mx-auto flex items-center justify-center px-4 py-4 md:px-6">
					<p className="text-xs text-white">
						&copy; {new Date().getFullYear()} Creative Abacus Academy. All
						rights reserved.
					</p>
				</div>
			</div>
