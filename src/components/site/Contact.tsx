...
export default function Contact() {
	...
	function onSubmit(values: z.infer<typeof formSchema>) {
		...
		toast({
			title: "Enquiry Sent!",
			description:
				"Thank you for reaching out. We'll get back to you soon to secure your admission slot.",
		});
		form.reset();
	}
			...
			<div className="container mx-auto px-4 md:px-6">
				...
				<div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-5">
					<div className="space-y-8 lg:col-span-2">
						...
						<BlurFade delay={0.4} inView>	<Card className="p-6  rounded-3xl">
							<div className="flex items-start gap-4">
					...
					<BlurFade delay={0.3} inView><Card className="p-6 rounded-3xl sm:p-8">
							...
							<Form {...form}>
								...
								>
									...
									<Button
										type="submit"
										size="lg"
										className="w-full rounded-full font-headline bg-accent text-accent-foreground hover:bg-accent/90"
									>
										Submit Enquiry
									</Button>
								</form>
						...
						<BlurFade delay={0.5} inView><Card className="p-6 rounded-3xl sm:p-8 mt-8">
							<h3 className="text-2xl  font-bold mb-2">
